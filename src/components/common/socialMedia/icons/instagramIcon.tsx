...
export function InstagramIcon() {
    return <svg
        className="transition group/insta hover:rotate-3 cursor-pointer w-full  h-fit"
        id="Layer_1"
        viewBox="0 0 32 32"
        xmlSpace="preserve"
        ...
        <g>
            ...
            />
            <g className="transition origin-center
                    group-hover/insta:-translate-y-0.5 
                    group-hover/insta:scale-105
                    drop-shadow">
